...
export interface ApiMedicineCategoryMedicineCategory
  ...
  attributes: {
    ...
    StorageRequirements: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    medicine_category: Schema.Attribute.Relation<
      ...
      'api::medicine-category.medicine-category'
    >;
    MedicineID: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    Strength: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  attributes: {
    ...
    RecievedStatus: Schema.Attribute.Boolean;
    UnitPriceAtOrder: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStockInventoryStockInventory
  ...
  attributes: {
    ...
    LastRestockDate: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-inventory.stock-inventory'
